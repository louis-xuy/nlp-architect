...
class Config(object):
    data_dir = '../../datasets/mta-lstm/'
    vec_file = '/Users/louis/Data/NLPData/sgns.baidubaike.bigram-char'
    init_scale = 0.04
    learning_rate = 0.001
    max_grad_norm = 10  # gradient clipping
    num_layers = 2
    num_steps = 200  # this value is one more than max number of words in sentence
    hidden_size = 20
